...
Danach einen Reboot und dann wieder über die Maintenance Firmware die aktuelle [Freifunk Nordhessen 1.5 Firmware (Factory Image) ](https://firmware.freifunk-nordhessen.de/images/1.5.0/sysupgrade/gluon-ff_nh-1.5.0-zyxel-nwa55axe-sysupgrade.bin)hochladen und installieren.
